...
export function OmniCaptureModal() {
  ...
  return (
    <div className="fixed inset-0 z-[999] bg-black/40 backdrop-blur-md flex items-center justify-center animate-in fade-in duration-150 p-4">
      ...
      <div className="w-full max-w-[600px] relative">
         ...
         <div className="mt-4 text-center">
            <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-white/30 bg-black/50 px-3 py-1.5 rounded-full backdrop-blur-sm border border-white/5">
              Press <kbd className="font-mono text-white/70 mx-1 px-1.5 py-0.5 bg-white/5 rounded border border-white/10">ESC</kbd> to abort
            </span>
         </div>
      </div>
    </div>
