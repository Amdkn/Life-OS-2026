# DDD-V0.6.6 — La Forge Tactique (M'Benga's Console)

> **ADR** : ADR-V0.6.6 · **Dossier** : `the-bridge-__-life-os/src/apps/twelve-week/`

---

## Phase A : Création de la Modale

### Étape A.1 : `TacticForgeModal.tsx`
**NOUVEAU FICHIER** : `src/apps/twelve-week/components/TacticForgeModal.tsx`
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <select 
                ...
                className="w-full bg-[#111] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-emerald-400/50 font-medium"
              >
...
```
*(Remarque A3 : Insérer les modales dans les fichiers qui utilisaient les prompts ou rendre ces modales accessibles globalement au dashboard).*
