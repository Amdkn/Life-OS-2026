MANDAT EXECUTABLE DE CETTE TRANCHE — job Amdkn/Life-OS-2026/PRD-015/t1
PRD exact : delegation-a-jules/categorie-1-agent-portal/PRD-015-RELATION-DIAGRAM-SKILL-TREE-NEXUS.md
Scope exclusif d'ecriture : src/apps/agent-portal/components/SkillsView.tsx, src/apps/agent-portal/components/RelationDiagram.tsx
Dependances et preuves :
- PRD-011 : PREUVE D'INTEGRATION = recu r-prd011-merged
- PRD-014 : PREUVE D'INTEGRATION ABSENTE — tranche bloquee tant que la preuve n'est pas fournie
...
---
# PRD SOURCE : delegation-a-jules/categorie-1-agent-portal/PRD-015-RELATION-DIAGRAM-SKILL-TREE-NEXUS.md
